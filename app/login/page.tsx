...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 font-sans" style={{ background: 'var(--bg-primary)' }}>
      <motion.div
      ...
      >
        ...
        <div className="relative z-10 text-center space-y-2 mb-8">
          <Link href="/" className="inline-block mb-4">
            <span className="text-2xl font-black tracking-tight" style={{ color: 'var(--text-primary)' }}>SUGOI</span>
          </Link>
          <h1 className="text-2xl font-bold tracking-tight" style={{ color: 'var(--text-primary)' }}>Admin Portal</h1>
        ...
        <form onSubmit={handleLogin} className="relative z-10 space-y-4">
          <div className="space-y-1 text-left">
            ...
            <input
              ...
              className="w-full rounded-2xl px-4 py-3 text-sm transition-all outline-none focus:ring-1 focus:ring-[var(--accent-pink)]"
          ...
          <motion.button
            ...
            type="submit"
            disabled={loading}
            className="w-full rounded-2xl px-4 py-3 text-sm font-bold uppercase tracking-wider transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed btn-glow"
          >
            {loading ? (
        ...
        <div className="text-center mt-6">
          <Link href="/" className="text-xs font-medium transition-colors hover:text-[var(--accent-pink)]" style={{ color: 'var(--text-muted)' }}>
            ← Back to Home
          </Link>
        </div>
      </motion.div>
