...
export function ResolutionCard({ resolutionText }: ResolutionCardProps) {
  ...
  return (
    <motion.div 
      ...
      className="w-full min-h-[300px] mt-4 bg-white/50 dark:bg-transparent backdrop-blur-2xl dark:backdrop-blur-none border border-white dark:border-transparent shadow-[0_8px_32px_0_rgba(0,0,0,0.05)] dark:shadow-none rounded-3xl p-6 md:p-8 relative z-20"
    >
      <div className="flex items-center gap-3 mb-6 border-b border-amber-200/50 dark:border-amber-900/30 pb-4">
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none text-slate-800 dark:text-slate-200 leading-relaxed
                      ...
                      prose-a:text-amber-600 dark:prose-a:text-amber-400 prose-strong:text-amber-700 dark:prose-strong:text-amber-500
                      prose-ol:list-decimal prose-ol:pl-5 prose-li:my-1 prose-li:pl-1
                      prose-pre:bg-transparent dark:prose-pre:bg-transparent
                      prose-code:bg-amber-50 dark:prose-code:bg-transparent prose-code:text-amber-900 dark:prose-code:text-amber-300 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:before:content-none prose-code:after:content-none">
