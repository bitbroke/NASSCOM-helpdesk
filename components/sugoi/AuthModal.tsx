      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            exit={{ opacity: 0 }}
            onClick={onClose}
            className="absolute inset-0 bg-taupe/20 backdrop-blur-md"
          />
            ...
            <div className="relative z-10 text-center space-y-6">
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  disabled={loading !== null}
                  className="w-full flex items-center justify-center gap-3 rounded-2xl px-4 py-3.5 text-sm font-bold transition-all bg-slate-900 text-white hover:bg-slate-800 shadow-lg shadow-slate-900/10 disabled:opacity-50"
                >
                  {loading === 'github' ? (
